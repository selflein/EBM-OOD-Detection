""" From https://github.com/chrischute/glow """
...
class Glow(nn.Module):
    ...
    Args:
        in_channels (int): Number of cannels of input.
    ...
    def __init__(self, in_channels, num_channels, num_levels, num_steps, k=256):
        ...
        self.flows = _Glow(
            in_channels=4 * in_channels,  # RGB image after squeeze
...
class _Glow(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, num_levels, num_steps):
        ...
        self.steps = nn.ModuleList(
            [
                _FlowStep(in_channels=in_channels, mid_channels=mid_channels)
